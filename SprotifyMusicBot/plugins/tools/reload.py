...
from SprotifyMusic.utils.database import get_authuser_names
...
async def reload_admin_cache(_client: Client, message: Message, _):
    try:
        ...
        await message.reply_text(
            "⚠️ Failure to recharge the administrators cache.Make sure the bot is administrator on your chat."
        )
