...
from SprotifyMusic.utils.decorators import admin_actual, language
from SprotifyMusic.utils.formatters import int_to_alpha
...
__HELP__ = f"""
<b>Authorized users can use administrator commands without administrator rights on their chat.</b>

<b>✧ {command("AUTH_COMMAND")}</b> [Username] - Add a user to the group's authorized list.

<b>✧ {command("UNAUTH_COMMAND")}</b> [Username] - Remove a user from the group's authorized list.

<b>✧ {command("AUTHUSERS_COMMAND")}</b> - Check the group's authorized list.
"""
