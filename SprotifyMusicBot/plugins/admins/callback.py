...
from SprotifyMusic.utils.decorators import actual_admin_cb
from SprotifyMusic.utils.decorators.language import language_cb
from SprotifyMusic.utils.formatters import seconds_to_min
from SprotifyMusic.utils.inline.play import (
    livestream_markup,
    panel_markup_1,
    panel_markup_2,
    panel_markup_3,
...
from SprotifyMusic.utils.thumbnails import gen_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
