...
from SprotifyMusic.utils.decorators.admins import actual_admin_cb
from SprotifyMusic.utils.decorators.language import language, language_cb
...
"""✅<u>Group Settings:</u>
/Settings - Get the full group settings with Inline buttons.

🔗 <u> Options in Settings: </u>

1. You can define audio quality.
2. You can define video quality.
3. ** Authorized Users **: You can change the manner of Admin commands to "all" or "only admins".
4. ** Clean mode **: Bot erases messages after 5 minutes in the group to keep the chat clean and organized.
5. ** Clean Command **: When activated, the bot will exclude the commands executed immediately.

<b><u>Playback Settings:</u></b>
/playmode - Get the full panel of buttons playback settings where you can adjust the group's playback settings.

<b> <u> Playmode Options: </u> </b>
1. ** Search mode ** [direct or inline] - Changes search mode when using the command /playmode.
2. ** Admin ** [all or admins] commands - if "all", anyone in the group can use Admin commands (such as /skip, /stop, etc).
3. ** Reproduction Type ** [All or Admons] - If "Admins", only the group's administrators will be able to play songs on the voice chat.
"""