...
from SprotifyMusic import HELPABLE, app
from SprotifyMusic.utils.database import get_lang, is_commanddelete_on
from SprotifyMusic.utils.decorators.language import language_start
from SprotifyMusic.utils.inline.help import private_help_panel
        ...
        key = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(text="🔄 To Close", callback_data="close"),
                ],
            ]
        )
